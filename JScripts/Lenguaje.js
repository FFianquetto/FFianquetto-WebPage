document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'ES': {
            ...
            'cadoWeb_title': 'CADO Web',
            'cadoWeb_description': 'Proyecto web frontend desarrollado para CADO. Características principales:',
            'cadoWeb_feature1': 'Diseño moderno y responsivo',
            'cadoWeb_feature2': 'Interfaz de usuario intuitiva',
            'cadoWeb_feature3': 'Optimización de rendimiento',
            'cadoWeb_feature4': 'Experiencia de usuario mejorada',
            'cadoWeb_list': 'CADO Web',
        ...
        'EN': {
            ...
            'artvlog_list': 'ArtVlog',
            'cadoWeb_title': 'CADO Web',
            'cadoWeb_description': 'Frontend web project developed for CADO. Main features:',
            'cadoWeb_feature1': 'Modern and responsive design',
            'cadoWeb_feature2': 'Intuitive user interface',
            'cadoWeb_feature3': 'Performance optimization',
            'cadoWeb_feature4': 'Enhanced user experience',
            'cadoWeb_list': 'CADO Web',
        ...
        'FR': {
            ...
            'artvlog_list': 'ArtVlog',
            'cadoWeb_title': 'CADO Web',
            'cadoWeb_description': 'Projet web frontend développé pour CADO. Principales caractéristiques :',
            'cadoWeb_feature1': 'Design moderne et responsive',
            'cadoWeb_feature2': 'Interface utilisateur intuitive',
            'cadoWeb_feature3': 'Optimisation des performances',
            'cadoWeb_feature4': 'Expérience utilisateur améliorée',
            'cadoWeb_list': 'CADO Web',
        ...
        'DE': {
            ...
            'artvlog_list': 'ArtVlog',
            'cadoWeb_title': 'CADO Web',
            'cadoWeb_description': 'Frontend-Webprojekt für CADO entwickelt. Hauptmerkmale:',
            'cadoWeb_feature1': 'Modernes und responsives Design',
            'cadoWeb_feature2': 'Intuitive Benutzeroberfläche',
            'cadoWeb_feature3': 'Leistungsoptimierung',
            'cadoWeb_feature4': 'Verbesserte Benutzererfahrung',
            'cadoWeb_list': 'CADO Web',
            'ec2_list': 'EC2-Container - AWS',
            'fleg_title': 'Fleg',
    ...
    function updateProjectCards(lang) {
        const cards = {
            ...
            'cadoWebCard': ['cadoWeb_title', 'cadoWeb_description', 'cadoWeb_feature1', 'cadoWeb_feature2', 'cadoWeb_feature3', 'cadoWeb_feature4'],
