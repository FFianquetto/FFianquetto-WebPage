      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
          ...
          <div class="mobile-icons d-flex d-lg-none">
            ...
            <button type="button" class="btn btn-link" onclick="handleMobileIconClick('experienciaModal')" style="color: #00ffa3;">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav-links navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#experienciaModal" data-lang="experiencia_nav" onclick="handleExperienciaClick(event)">Experiencia</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#certificaciones" data-lang="certificados">Certificados</a>
              </li>
              <li class="nav-item">
