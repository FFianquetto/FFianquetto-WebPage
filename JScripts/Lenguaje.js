document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'ES': {
            ...
            'exp_1': 'iOS Lab UANL',
            'exp_1_period': 'Dic 2025 — Actualidad · 6 meses',
            'exp_2': 'Programador Jr. — Empresa Virtual (SumApp)',
            'exp_2_period': 'Ago 2025 – Feb 2026 · 7 meses',
            'exp_3': 'Programador Jr. — Cado (Festival Destacado)',
            'exp_3_period': 'Ago 2024 – Feb 2025 · 7 meses (6 prácticas + 1 web)',
            'exp_4': 'Hackathons',
            ...
            'escape_list': 'Escape Salvaje en Unreal Engine',
            ...
            'escape_title': "Escape Salvaje en Unreal Engine",
            'escape_description': "Juego de aventura y supervivencia desarrollado en Unreal Engine con mecánicas de escape y puzzle. Características principales:",
            ...
            'appSumapp_description': 'Aplicación móvil de monitoreo empresarial desarrollada en Flutter, con sincronización vía API REST hacia un backend PHP y base de datos MySQL. Características principales:',
            'appSumapp_feature1': 'Interfaz y lógica en Flutter multiplataforma',
            'appSumapp_feature2': 'Base de datos local SQLite para operación offline',
            'appSumapp_feature3': 'Comunicación JSON con servidor backend PHP',
            'appSumapp_feature4': 'Sincronización con base de datos remota MySQL',
        ...
        'EN': {
            ...
            'exp_1': 'iOS Lab UANL',
            'exp_1_period': 'Dec 2025 — Present · 6 months',
            'exp_2': 'Jr. Developer — Virtual Company (SumApp)',
            'exp_2_period': 'Aug 2025 – Feb 2026 · 7 months',
            'exp_3': 'Jr. Developer — Cado (Festival Destacado)',
            'exp_3_period': 'Aug 2024 – Feb 2025 · 7 months (6 internship + 1 web)',
            'exp_4': 'Hackathons',
            ...
            'escape_list': 'Wild Escape in Unreal Engine',
            ...
            'escape_title': "Wild Escape in Unreal Engine",
            'escape_description': "Adventure and survival game developed in Unreal Engine with escape and puzzle mechanics. Main features:",
            ...
            'bimboSIS_list': 'BimboSIS',
            'appSumapp_title': 'AppSumapp',
            'appSumapp_description': 'Business monitoring mobile app built with Flutter, syncing via REST API to a PHP backend and MySQL database. Main features:',
            'appSumapp_feature1': 'Cross-platform UI and logic in Flutter',
            'appSumapp_feature2': 'Local SQLite database for offline operation',
            'appSumapp_feature3': 'JSON communication with PHP backend server',
            'appSumapp_feature4': 'Synchronization with remote MySQL database',
            'appSumapp_list': 'AppSumapp',
            'fleg_title': 'Fleg',
        ...
        'FR': {
            ...
            'exp_1': 'iOS Lab UANL',
            'exp_1_period': 'Déc 2025 — Actuellement · 6 mois',
            'exp_2': 'Programmeur Jr. — Entreprise Virtuelle (SumApp)',
            'exp_2_period': 'Aoû 2025 – Fév 2026 · 7 mois',
            'exp_3': 'Programmeur Jr. — Cado (Festival Destacado)',
            'exp_3_period': 'Aoû 2024 – Fév 2025 · 7 mois (6 stage + 1 web)',
            'exp_4': 'Hackathons',
            ...
            'appSumapp_title': 'AppSumapp',
            'appSumapp_description': 'Application mobile de suivi d\'entreprise développée en Flutter, avec synchronisation via API REST vers un backend PHP et une base MySQL. Principales caractéristiques :',
            'appSumapp_feature1': 'Interface et logique multiplateforme en Flutter',
            'appSumapp_feature2': 'Base de données locale SQLite pour le mode hors ligne',
            'appSumapp_feature3': 'Communication JSON avec serveur backend PHP',
            'appSumapp_feature4': 'Synchronisation avec base de données MySQL distante',
            'appSumapp_list': 'AppSumapp',
            'fleg_title': 'Fleg',
            ...
            'escape_list': 'Évasion Sauvage dans Unreal Engine',
            ...
            'escape_title': "Évasion Sauvage dans Unreal Engine",
            'escape_description': "Jeu d'aventure et de survie développé dans Unreal Engine avec des mécaniques d'évasion et de puzzle. Caractéristiques principales :",
        ...
        'DE': {
            ...
            'exp_1': 'iOS Lab UANL',
            'exp_1_period': 'Dez 2025 — Aktuell · 6 Monate',
            'exp_2': 'Jr. Entwickler — Virtuelles Unternehmen (SumApp)',
            'exp_2_period': 'Aug 2025 – Feb 2026 · 7 Monate',
            'exp_3': 'Jr. Entwickler — Cado (Festival Destacado)',
            'exp_3_period': 'Aug 2024 – Feb 2025 · 7 Monate (6 Praktikum + 1 Web)',
            'exp_4': 'Hackathons',
            ...
            'ec2_list': 'EC2-Container - AWS',
            'appSumapp_title': 'AppSumapp',
            'appSumapp_description': 'Mobile Unternehmensüberwachungs-App mit Flutter, Synchronisation per REST-API mit PHP-Backend und MySQL-Datenbank. Hauptmerkmale:',
            'appSumapp_feature1': 'Plattformübergreifende Oberfläche und Logik in Flutter',
            'appSumapp_feature2': 'Lokale SQLite-Datenbank für Offline-Betrieb',
            'appSumapp_feature3': 'JSON-Kommunikation mit PHP-Backend-Server',
            'appSumapp_feature4': 'Synchronisation mit remote MySQL-Datenbank',
            'appSumapp_list': 'AppSumapp',
            'fleg_title': 'Fleg',
            ...
            'bolos_feature4': "Detailliertes Punktesystem und realistische Spielmechanik",
            'escape_title': "Wild Escape in Unreal Engine",
            'escape_description': "Abenteuer- und Überlebensspiel entwickelt in Unreal Engine mit Escape- und Puzzle-Mechaniken. Hauptmerkmale:",
...
const projects = [
    ...
    {
        id: 'escapeCard',
        title: 'Escape Salvaje en Unreal Engine',
        description: 'Juego de aventura y supervivencia en Unreal Engine con mecánicas de escape y puzzle.',
        category: 'game',
        color: '#ff4ecd'
    },
    {
